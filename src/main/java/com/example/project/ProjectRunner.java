...
public class ProjectRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        MyUser myUser = new MyUser("1234", "user@project.com", "pass", new DriverLicense("123456", null), Arrays.asList(UserRole.USER), AccountStatus.ACTIVE, null);
        MyUser myAdmin = new MyUser("1235", "admin@project.com", "pass", new DriverLicense("123457", null), Arrays.asList(UserRole.ADMIN), AccountStatus.ACTIVE, null);

        Vehicle vehicle1 = new Vehicle("ka01mh1268", new GeoLocation(10.2, 15.2), new ArrayList<>(), "CAR", null);
        Vehicle vehicle2 = new Vehicle("ka01mh1355", new GeoLocation(10.2, 15.2), new ArrayList<>(), "BIKE", null);
